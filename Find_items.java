 ...
 * @author Blocker
 */
class Find_items extends JFrame{
...
JTable table = new JTable();
 ...
 Object[] columns = {"Item ID","Item Description","Unit Price","Quantity","Company","Date Time"};
...
DocumentListener  documentListener = new DocumentListener() {
            ...
            private void printIt(DocumentEvent documentEvent) {
               ...
               // ta.setText("No Information");
                try {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/Super_market_system", "root", "");
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery("SELECT * FROM All_item WHERE Item_ID ='" + t.getText() + "'");
                    ...
                    while (rs.next()) {
                        ...
                        model.addRow(row);
                        //int i = table.getSelectedRow();
                        l1.setText(rs.getString("ind_no"));
 ...
 JLabel nn = new JLabel ("Find Items");
