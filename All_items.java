 ...
 * @author Blocker
 */
class All_items extends JFrame{
...
JTable table = new JTable();
 ...
 Object[] columns = {"Item ID","Item Description","Quantity","Last Date_Time"};
...
Object[] row = new Object[4];
           ...
           try {
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM item_stock");
                    ...
                    while (rs.next()) {
                        ...
                        row[3] = rs.getString("Update_date_time");
...
JButton item = new JButton("Stock");
        
    add(item);
    
JButton bill = new JButton("All Item"); 
...
bill.setBounds(0, 0, 0, 0);
 ...
 Object[] columns = {"Item ID","Item Description","Suppler ID","Unit Price","Quantity","Order No","Company","Date Time"};
	DefaultTableModel model = new DefaultTableModel();
	model.setColumnIdentifiers(columns);   
...
Object[] row = new Object[8];
           ...
           try {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/Super_market_system", "root", "");
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery("SELECT * FROM all_item ");

                    while (rs.next()) {

                        row[0] = rs.getString("Item_ID");
                        row[1] = rs.getString("Item_Description");
                        row[2] = rs.getString("Suppler_ID");
                        row[3] = rs.getString("Unit_Price");
                        row[4] = rs.getString("Quantity");
                        row[5] = rs.getString("Order_No");
                        row[6] = rs.getString("Company");
                        row[7] = rs.getString("Date_Time");
...
Object[] row = new Object[4];
 ...
 JLabel nn = new JLabel ("All Items");
